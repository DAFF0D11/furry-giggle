;;; doom-dark-horizon-theme.el --- Inspired by VSCode Horizon -*- lexical-binding: t; no-byte-compile: t; -*-
...
;;
(def-doom-theme doom-dark-horizon
  ...
  (((font-lock-comment-face &override)
   ...
   (link :foreground yellow )
   ((line-number &override) :foreground hor-highlight-selected)
   ((line-number-current-line &override) :foreground hor-highlight-brighter :background bg)
   (mode-line
  ...
  (tab-bar-tab-inactive :foreground base3 :background bg) 
...
;;; doom-dark-horizon-theme.el ends here

;; White bar between vertical splits. Ugly considering you cant do it horizontally to match.
