...
;; Inspired by:
;;
;; https://bitbucket.org/kisom/dink.vim
;; https://github.com/dmand/dink.el
...
(let ((fg "#111111")
  ...
  (custom-theme-set-faces
   ...
   `(vertical-border ((t (:background, bg :foreground, fg)))) ;; between splits
   ...
   ;; Avy
   `(avy-lead-face ((t (:background, bg :foreground, "red" ))))
   `(avy-lead-face-0 ((t (:background,bg :foreground , "blue" ))))
   `(avy-lead-face-1 ((t (:background, bg :foreground, "green" ))))
   `(avy-lead-face-2 ((t (:background, bg :foreground, "yellow" ))))
