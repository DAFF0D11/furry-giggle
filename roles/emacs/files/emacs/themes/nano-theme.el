...
(defcustom nano-dark-background "#000000" ;; Polar Night 0 / nord  0
  "Default background color"
  :type 'color :group 'nano-dark)
...
(let ((light     '((background light)))
  ...
  (custom-theme-set-faces
   ...
   `(highlight ((,light (:background ,nano-light-subtle))
   ...
   `(mode-line ((,light (:foreground ,nano-light-subtle
                         :background ,nano-light-background
                         :box nil
                         ))
        (,dark  (:foreground ,nano-dark-foreground
   ...
   `(mode-line-inactive ((,light (:foreground ,nano-light-subtle
                                  :background ,nano-light-background
                                  :box nil
                                  ))
             (,dark  (:foreground ,nano-dark-faded
   ...
   ;; --- Elfeed -------------------------------------------------------
    ...
    ;; Fix terminal completion color
   `(vterm-color-black ((t (:background, "#999999" :foreground,"#999999" ))))
