...
(let ((colors '(;; Upstream theme color
                (dracula-bg      "#0c0c0e" "unspecified-bg" "unspecified-bg") ; official background
                (dracula-fg      "#e1c2a8" "#e1c2a8" "brightwhite") ; official foreground
                (dracula-current "#5C2F25" "#5C2F25" "brightblack") ; official current-line/selection
                (dracula-comment "#353845" "#353845" "blue")        ; official comment
                (dracula-cyan    "#584240" "#584240" "brightcyan")  ; official cyan
                (dracula-green   "#554E55" "#554E55" "green")       ; official green
                (dracula-orange  "#95341E" "#95341E" "brightred")   ; official orange
                (dracula-pink    "#AE5A38" "#AE5A38" "magenta")     ; official pink
                (dracula-purple  "#e1c2a8" "#e1c2a8" "brightmagenta") ; official purple
                (dracula-red     "#9d8775" "#9d8775" "red")         ; official red
                (dracula-yellow  "#5C2F25" "#5C2F25" "yellow")      ; official yellow
                ;; Other colors
                (bg2             "#353845" "#121212" "brightblack")
