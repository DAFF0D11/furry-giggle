;; hello-theme.el --- A minimalistic custom theme for Emacs
...
(custom-theme-set-faces
 ...
 `(font-lock-type-face              ((t (:bold, nil :foreground, yellow ))))
 `(font-lock-builtin-face           ((t (:bold, nil :foreground, yellow))))
...
;; Markdown
 `(markdown-pre-face ((t (:background, backg :foreground, magenta ))))
